...
class DiscCloudFunctions(GcpDisc):
    ...
    def _disc_cloudfunction(self, p_obj: GcpProject):
        ...
        for loc in locations:
            ...
            functions: List[str] = self.execute_http_req(http_prep, "functions", disable_warn=True,
            ...
            for func in functions:
                cf_obj = GcpCloudFunction(
                    ...
                    environmentVariables=json.dumps(
                        func["environmentVariables"]) if "environmentVariables" in func else "",
                ...
                if source_repo := func.get("sourceRepository"):
