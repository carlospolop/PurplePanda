...
class DiscBigquery(GcpDisc):
    ...
    def _disc_tables(self, ds_obj: GcpBqDataset, project_id):
        ...
        tables: List[str] = self.execute_http_req(http_prep, "tables", disable_warn=True,
                                                  list_kwargs={"datasetId": ds_obj.datasetId, "projectId": project_id})
    ...
    def _get_rowAccessPolicies(self, table_obj, ds_id, project_id):
        ...
        access_policies: List[str] = self.execute_http_req(http_prep, "something",
                                                           list_kwargs={"datasetId": ds_id, "projectId": project_id,
