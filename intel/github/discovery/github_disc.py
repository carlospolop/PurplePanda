...
class GithubDisc(GithubDiscClient):
    ...
    def get_members(self, github_obj, n4j_obj):
        ...
        self._disc_loop(members, self._get_member, __name__.split(".")[-1]+f".get_members({n4j_obj.name})", **{"n4j_obj": n4j_obj, "github_obj": github_obj})
        n4j_obj.save()
    ...
    def get_teams(self, github_obj, n4j_obj):
        ...
        self._disc_loop(teams, self._get_team, __name__.split(".")[-1]+f".get_teams({n4j_obj.name})", **{"n4j_obj": n4j_obj, "github_obj": github_obj})
        n4j_obj.save()
    ...
    def get_repos(self, github_obj, n4j_obj):
        ...
        self._disc_loop(repos, self._get_repo, __name__.split(".")[-1]+f".get_repos({n4j_obj.name})", **{"n4j_obj": n4j_obj, "github_obj": github_obj})
        n4j_obj.save()
    ...
    def get_leaks(self, github_repo) -> dict:
        ...
        try:
            ...
            subprocess.call(["rm", "-rf", "/tmp/gitleaks.json"], stdout=open(os.devnull, 'wb'), stderr=open(os.devnull, 'wb'))
